package com.airline.rest.search;
...
@Path("/v1/search")
public class Search_V1 extends DBConnect{
	/**
	...
	public Response searchFlights(String incomingData) throws Exception {
		...
		try {
			 ...
			 */
			returnString = (String) c.get(partsData.optString("source")+partsData.optString("dest"));
			System.out.println("json is: "+returnString);
			if(returnString == null){
				System.out.println("went to set the cache");
				jsonArray = dao.queryReturnFlightDetails(partsData.optString("source"), 
														partsData.optString("dest") );

				c.set(partsData.optString("source")+partsData.optString("dest"), 3600, jsonArray.toString());
