package com.airline.rest.agentLogin;
...
@Path("/v1/agentLogin")
public class AgentLogin extends DBConnect{
	/**
	...
	public Response searchFlights(String incomingData) throws Exception {
		...
		try {
			 ...
			 */
			jsonArray = dao.queryReturnAgentDetails(partsData.optString("username"), 
														partsData.optString("pwd") );
